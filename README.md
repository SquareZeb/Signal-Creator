...
From there you may change the resolution of the image by setting the X and Y ranges, once you've done that you will hit refresh button and click on the sound file to generate a new resolution image. Now remember larger resolutions will require more time to calculate and process. Once you feel satisfied you may either export just one or export all of the sounds as images.
